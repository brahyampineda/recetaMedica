...
public class MedicoGeneral implements Serializable {
    ...
    @JoinTable(name = "medico_general_has_tratamiento", joinColumns = {
        @JoinColumn(name = "Medico_general_idMedico_general", referencedColumnName = "idMedico_general")}, inverseJoinColumns = {
    ...
    public MedicoGeneral(int idMedicogeneral, int usuarioidUsuario) {
