...
public class MedicoEspecialista implements Serializable {
    ...
    @JoinTable(name = "medico_especialista_has_tratamiento", joinColumns = {
        ...
        @JoinColumn(name = "Medico_especialista_Usuario_idUsuario", referencedColumnName = "Usuario_idUsuario")}, inverseJoinColumns = {
    ...
    public MedicoEspecialista(int idMedicoespecialista, String usuarioidUsuario) {
