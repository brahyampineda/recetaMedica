...
public class RegistroPK implements Serializable {
    ...
    public RegistroPK(int idRegistro, String usuarioidUsuario, String administradoridAdministrador, String administradorUsuarioidUsuario) {
    ...
    public String toString() {
        return "com.utp.receta_medica.entidades.RegistroPK[ idRegistro=" + idRegistro + ", usuarioidUsuario=" + usuarioidUsuario + ", administradoridAdministrador=" + administradoridAdministrador + ", administradorUsuarioidUsuario=" + administradorUsuarioidUsuario + " ]";
    }
